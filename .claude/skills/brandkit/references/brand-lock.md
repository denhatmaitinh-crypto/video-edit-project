...
The working Brand Lock may contain draft concept language, but final approvals live only in `.brandkit/state.json` inside the current chat's sandbox workspace.
